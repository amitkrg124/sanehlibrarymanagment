...
export const DEFAULT_SETTINGS: LibrarySettings = {
  ...
  eveningStart: '14:00',
  eveningEnd: '21:00',
  defaultAfternoonFee: 1200,
  defaultEveningFee: 1200,
  defaultFullDayFee: 2000,
...
export const MOCK_FEE_RECORDS: FeeRecord[] = [
  ...
  { id: 'fee-001', studentId: 'stu-001', periodStart: '2026-07-12', periodEnd: '2026-08-11', amount: 1200, dueDate: '2026-07-12', paidDate: '2026-07-13', status: 'paid', paymentMethod: 'cash', createdAt: '2026-07-12T10:00:00Z' },
  { id: 'fee-002', studentId: 'stu-001', periodStart: '2026-08-12', periodEnd: '2026-09-11', amount: 1200, dueDate: '2026-08-12', status: 'overdue', createdAt: '2026-08-12T10:00:00Z' },
  // Priya Sharma (stu-002) - admission 15 Jul
  { id: 'fee-003', studentId: 'stu-002', periodStart: '2026-07-15', periodEnd: '2026-08-14', amount: 1200, dueDate: '2026-07-15', paidDate: '2026-07-16', status: 'paid', paymentMethod: 'upi', createdAt: '2026-07-15T11:00:00Z' },
  { id: 'fee-004', studentId: 'stu-002', periodStart: '2026-08-15', periodEnd: '2026-09-14', amount: 1200, dueDate: '2026-08-15', paidDate: '2026-08-16', status: 'paid', paymentMethod: 'upi', createdAt: '2026-08-15T11:00:00Z' },
  // Amit Deshmukh (stu-003) - admission 18 Jul
  { id: 'fee-005', studentId: 'stu-003', periodStart: '2026-07-18', periodEnd: '2026-08-17', amount: 2000, dueDate: '2026-07-18', paidDate: '2026-07-19', status: 'paid', paymentMethod: 'cash', createdAt: '2026-07-18T09:00:00Z' },
  { id: 'fee-006', studentId: 'stu-003', periodStart: '2026-08-18', periodEnd: '2026-09-17', amount: 2000, dueDate: '2026-08-18', status: 'overdue', createdAt: '2026-08-18T09:00:00Z' },
  // Neha Patil (stu-004) - admission 20 Jul
  { id: 'fee-007', studentId: 'stu-004', periodStart: '2026-07-20', periodEnd: '2026-08-19', amount: 1200, dueDate: '2026-07-20', paidDate: '2026-07-21', status: 'paid', paymentMethod: 'upi', createdAt: '2026-07-20T10:00:00Z' },
  { id: 'fee-008', studentId: 'stu-004', periodStart: '2026-08-20', periodEnd: '2026-09-19', amount: 1200, dueDate: '2026-08-20', status: 'upcoming', createdAt: '2026-08-20T10:00:00Z' },
  // Vijay Singh (stu-005) - admission 22 Jul
  { id: 'fee-009', studentId: 'stu-005', periodStart: '2026-07-22', periodEnd: '2026-08-21', amount: 1200, dueDate: '2026-07-22', paidDate: '2026-07-23', status: 'paid', paymentMethod: 'cash', createdAt: '2026-07-22T10:00:00Z' },
  { id: 'fee-010', studentId: 'stu-005', periodStart: '2026-08-22', periodEnd: '2026-09-21', amount: 1200, dueDate: '2026-08-22', status: 'overdue', createdAt: '2026-08-22T10:00:00Z' },
  // Ankita Joshi (stu-006) - admission 1 Aug
  { id: 'fee-011', studentId: 'stu-006', periodStart: '2026-08-01', periodEnd: '2026-08-31', amount: 2000, dueDate: '2026-08-01', paidDate: '2026-08-02', status: 'paid', paymentMethod: 'upi', createdAt: '2026-08-01T09:30:00Z' },
  // Saurabh Rao (stu-007) - admission 5 Aug  
  { id: 'fee-012', studentId: 'stu-007', periodStart: '2026-08-05', periodEnd: '2026-09-04', amount: 1200, dueDate: '2026-08-05', paidDate: '2026-08-06', status: 'paid', paymentMethod: 'cash', createdAt: '2026-08-05T11:00:00Z' },
  // Pooja Mehta (stu-008) - admission 8 Aug
  { id: 'fee-013', studentId: 'stu-008', periodStart: '2026-08-08', periodEnd: '2026-09-07', amount: 1200, dueDate: '2026-08-08', paidDate: '2026-08-08', status: 'paid', paymentMethod: 'upi', createdAt: '2026-08-08T10:00:00Z' },
  // Karan Verma (stu-009) - admission 10 Aug
  { id: 'fee-014', studentId: 'stu-009', periodStart: '2026-08-10', periodEnd: '2026-09-09', amount: 1200, dueDate: '2026-08-10', paidDate: '2026-08-11', status: 'paid', paymentMethod: 'upi', createdAt: '2026-08-10T09:00:00Z' },
  // Ritu Gupta (stu-010) - admission 12 Aug
  { id: 'fee-015', studentId: 'stu-010', periodStart: '2026-08-12', periodEnd: '2026-09-11', amount: 1200, dueDate: '2026-08-12', paidDate: '2026-08-13', status: 'paid', paymentMethod: 'cash', createdAt: '2026-08-12T10:30:00Z' },
  // Manoj Pandey (stu-011) - admission 15 Aug
  { id: 'fee-016', studentId: 'stu-011', periodStart: '2026-08-15', periodEnd: '2026-09-14', amount: 2000, dueDate: '2026-08-15', paidDate: '2026-08-16', status: 'paid', paymentMethod: 'cash', createdAt: '2026-08-15T09:00:00Z' },
  // Sneha Kulkarni (stu-012) - admission 18 Aug - upcoming
  { id: 'fee-017', studentId: 'stu-012', periodStart: '2026-08-18', periodEnd: '2026-09-17', amount: 1200, dueDate: '2026-08-18', paidDate: '2026-08-18', status: 'paid', paymentMethod: 'upi', createdAt: '2026-08-18T10:00:00Z' },
  // Deepak Nair (stu-013) - admission 10 Jun
  { id: 'fee-018', studentId: 'stu-013', periodStart: '2026-07-10', periodEnd: '2026-08-09', amount: 1200, dueDate: '2026-07-10', paidDate: '2026-07-11', status: 'paid', paymentMethod: 'cash', createdAt: '2026-07-10T10:00:00Z' },
  { id: 'fee-019', studentId: 'stu-013', periodStart: '2026-08-10', periodEnd: '2026-09-09', amount: 1200, dueDate: '2026-08-10', paidDate: '2026-08-12', status: 'paid', paymentMethod: 'upi', createdAt: '2026-08-10T10:00:00Z' },
  // Kavita Bhat (stu-014) - admission 20 Jun
  { id: 'fee-020', studentId: 'stu-014', periodStart: '2026-07-20', periodEnd: '2026-08-19', amount: 1200, dueDate: '2026-07-20', paidDate: '2026-07-21', status: 'paid', paymentMethod: 'cash', createdAt: '2026-07-20T09:00:00Z' },
  { id: 'fee-021', studentId: 'stu-014', periodStart: '2026-08-20', periodEnd: '2026-09-19', amount: 1200, dueDate: '2026-08-20', status: 'upcoming', createdAt: '2026-08-20T09:00:00Z' },
];
